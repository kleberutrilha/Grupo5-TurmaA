...
public class menu {
		...
		public static void main(String[] args) throws Exception {
			...
			do {
				...
				if (escolha_menu == 1) {// Cada número levará a uma determinada opção.
					...
					Digita("Que pena que vai sair, aguardamos o seu retorno para mais desafios!", TimeUnit.MILLISECONDS, temp_narrativa);
					System.exit(0);
				} else {
		...
		// Para cada Laço de repetição, será usado um booleano, inicialmente sendo falso:
				boolean saida = false;
		
		// utilização de uma estrutura de repetição DO WHILE, caso o usuário digitar uma opção que não existe:
		do {
		...
		do {
			...
			case "A":
				Digita("\n   Ótimo! Mas você está preparado para um desafio administrativo no RH? Não vamos te enganar... A situação aqui é caótica...  ",TimeUnit.MILLISECONDS, temp_narrativa);
				saida3=true;
				break;
				
			case "B":
				Digita("\n\n   Você pode até ignorar isso, mas será momentaneo. Afinal, o desafio começará AGORA! ",TimeUnit.MILLISECONDS, temp_narrativa);
				saida3=true;
				break;
		...
		do {
			...
			case "C":
				Digita("\n   Outro candidato encontrou um gasto desnecessário com a camada de silicio utilizada no chip, ele relatou a Tech Recruiter sobre a possivel troca de"
						...
						TimeUnit.MILLISECONDS, temp_narrativa);
				perdeu++;
				// aparti do terceiro desafio é verificado se o usuário errou três vezes, se sim, game over(perde o jogo):
				if(perdeu==3) {
				Digita("\n   Não aceitamos tantas falhas assim, você errou 3 vezes e isso já é mais que o suficiente para não se considerar um VP a altura da grande FULL BODY TECH..."
						+"\n   Mesmo em fases de testes não aceitamos tantos erros...\n   O CEO junto com sua Tech Recruiter conversam entre si e o chama...\n\n   \"Você não é considerado um"
						+ " concorrente apto a participar dos demais desafios, VOCÊ ESTA DESCLASSIFICADO \"\n\n   Você incrédulo com a noticia, tenta convence-los do contrário, mas já é tarde"
						+ " demais...Agora lhe resta apenas aceitar!\n   Quem sabe um dia eles te aceitem de novo a se candidatar novamente, mas até lá, sem chances..\n   Boa sorte na nova jornada"
			...
			Digita("\n   \"Bem-vindos meus caros viajantes intergaláticos, esse é nosso espaço de pesquisas espaciais onde procuramos por diversas"
					+ " formas de vidas que nosso universo abriga, ao qual,\n   ainda não conhecemos.\n",
					TimeUnit.MILLISECONDS, temp_narrativa);
		...
		do {
			...
			Digita("\n   A Tech Recruiter juntamente com o CEO da FULL BODY TECH recebem todos os candidatos que chegaram na fase final, e iniciam o dia com um discurso"
			...
			if (cont_Taylor > cont_Fayol) { // Contagem dos pontos de todas as perguntas, que definirá se o jogador, tem caracteristicas do Taylor ou Fayol
				// Frase de exibição, se tiver mais respostas relacionadas a Taylor:
				Digita("\n\n   Sua semana foi muito intensa e cheia de desafios diversos para avaliarem seu comportamento e ver se você, candidato, estava apto ou não a ser contratado e em qual\n"
						+ "   perfil você mais se destaca..POIS BEM AQUI VAI A RESPOSTA TÃO ESPERADA: \n\n   O CEO, todo poderoso da FULL BODY TECH discursa sobre a semana de desafios e de como foi"
						+ " uma avaliação árdua, mas que já tomou a decisão.\n   VOCÊ conseguiu a tão sonhada vaga para se tornar VP da poderosa empresa, com suas atitudes mais voltadas ao chão de"
						+ " fabrica, e utiização da ciência, do que da\n   experiência vivida, com foco em trazer bons sálarios e aumentar a produção assim melhorando mais ainda a empresa, você,"
						...
						+ " jornada nesta nova fase,  até os próximos desafios!\n   Com certeza nos veremos ainda! :D ",TimeUnit.MILLISECONDS, temp_narrativa);
				
			} else if (cont_Fayol > cont_Taylor) {
				// Frase de exibição, se tiver mais respostas relacionadas a Fayol:
				Digita("\n\n   Sua semana foi muito intensa e cheia de desafios diversos para avaliarem seu comportamento e ver se você, candidato, estava apto ou não a ser contratado e em qual\n"
						+ "   perfil você mais se destaca..POIS BEM AQUI VAI A RESPOSTA TÃO ESPERADA: \n\n   O CEO, todo poderoso da FULL BODY TECH discursa sobre a semana de desafios e de como foi"
						+ " uma avaliação árdua, mas que já tomou a decisão.\n   VOCÊ conseguiu a tão sonhada vaga para se tornar VP da poderosa empresa, com suas atitudes mais voltada a estrutura" 
						+ " organizacional, melhorando a divisão de trabalho e\n   definindo autoridades e uma unidade de direção, melhorando mais ainda a empresa, você candidato, foi caracterizado" 
						+ " como \n   \"Tyger Fayol's\"\n   e esta preparado para ser o VICE PRESIDENT da FULL BODY TECH. \n\n   Sorte é algo que não lhe serve, por isso Boa jornada nesta nova fase, e até os"
						+ " próximos desafios!\n   Com certeza nos veremos ainda! :D",TimeUnit.MILLISECONDS, temp_narrativa);
				
			} else if (cont_Taylor == cont_Fayol) {
				//Será passado um desafio final para verificar qual perfil é mais predominante, Fayol ou Taylor:
